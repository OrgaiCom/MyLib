...
namespace CommonClass
{
    ...
    public class LibData
    {
        ...
        public string DataTableToString(DataTable dt, string delimiter = "\t")
        {
            string ret = "";
        ...
        public DataTable DataTableFromString(string str)
        {
        ...
        /// <param name="str">DataTableに変換する文字列</param>
        /// <returns>DataTable | 変換後のDataTable</returns>
        public DataTable DataTableFromStringConvertEscapeSequence(string str)
        {
            DataTable dt = new DataTable();
            string tmp;
            string[] lines;
            ...
            if (lines.Length > 0)
            {
                ...
                foreach (string header in headers)
                {
                    ...
                    conv = libStr.ConvertEscapeSequence(header);
                ...
                for (int i = 1; i < lines.Length; i++)
                {
                    if (lines[i] != "")
                    {
                        ...
                        for (int j = 0; j < fields.Length; j++)
                        {
                            ...
                            conv = libStr.ConvertEscapeSequence(field);
